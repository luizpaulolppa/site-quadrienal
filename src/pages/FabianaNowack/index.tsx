  ...
  return (
    <Container>
      ...
      <HighlightsContainer>
        ...
        <br />
        <HighlightsText>
          A equipe do departamento de Educação que atua apoiando as escolas,
          conta com:
        </HighlightsText>
        <br /> <br />
        <HighlightsText>
          ...
          <br />
          <br />
          Orientadora Educacional de Inclusão —{" "}
          ...
          <br />
          Nutricionista —{" "}
          <HighlightsText className="green">Pâmela Silva</HighlightsText>
          <br />
          <br />
        ...
        <br />
        <HighlightsText>
          Esta é uma concessão governamental à Instituição Adventista de
          Educação, regida por legislação nacional própria que visa à concessão
          de bolsas de estudos para famílias que se enquadram num perfil
          socioeconômico específico. Os critérios são apresentados no Edital de
          Filantropia, divulgado em cada escola, no período da campanha de
          matrículas.
        </HighlightsText>
        <br />
        <br />
        <HighlightsText>
          Para terem acesso à gratuidade escolar de 50% ou 100%, pais ou
          responsáveis enviam a documentação (conforme edital nacional de
          filantropia) de forma on-line, para ser analisada pela assistente
          social. O resultado é divulgado (de acordo com edital nacional de
          filantropia) mediante as vagas existentes nas turmas de cada unidade e
          o percentual de alunos pagantes matriculados, conforme a legislação
          vigente. Desta forma, várias famílias são atendidas pela escola a cada
          ano.
        </HighlightsText>
        <br />
        <br />
        ...
        <br />
        <HighlightsTitle>
          Implementação do Ensino Médio em Cachoeirinha
        </HighlightsTitle>
        <br />
        <br />
        <HighlightsText>
          Em 2019, o Conselho Estadual de Educação autorizou a realização do
          Ensino Médio na unidade escolar em Cachoeirinha. Assim, em 2020, 59
          alunos iniciaram o Ensino Médio nas turmas de 1º e 2º anos. Em 2021,
          houve a formatura da primeira turma do Ensino Médio do Colégio
        ...
        <br />
        <HighlightsText>
          Em 11 de dezembro de 2019, o Conselho Estadual de Educação autorizou o
          início dos trabalhos da Escola Adventista de Canoas. Em 28 de janeiro
          de 2020, a Escola foi inaugurada numa cerimônia com autoridades
          denominacionais, municipais e estaduais, além de funcionários, novos
          ...
          primeiro dia letivo da escola. Nos anos seguintes, o gráfico mostra o
        ...
        <HighlightsText>
          ...
          em fase de elaboração do projeto arquitetônico dos novos prédios para
        ...
        <br />
        <HighlightsText>
          Escola Adventista de Cachoeira do Sul — Construção de duas novas salas
          de aula com 170,60 m² de construção.
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <br />
        <HighlightsText>
          Em 2019, aconteceram duas ampliações com área de 566,58 m²,
          compreendendo seis salas de aulas, laboratório de Química, Física e
          Biologia, parque indoor e novas salas de atendimento, além da reforma
          para nova biblioteca e nova sala de professores com área de 265,62 m².
        </HighlightsText>
        <br />
        <HighlightsText>
          Em 2021 e 2022, um prédio de quatro andares foi construído para
          aumento do pátio de alunos, quatro salas de aulas, salas de recursos,
          sala de reforço, ginásio coberto, quadras esportivas descobertas, sala
          maker, depósitos para banheiros e afins, num total de 1.871,82 m².
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <HighlightsText>
          ...
          que contam com: área administrativa, oito salas administrativas, nove
          salas de aula, biblioteca, sala dos professores, laboratório de
          Química, Física e Biologia compreendendo uma área ampliada de 2.665,61
          m².
        </HighlightsText>
        <br />
        <br />
        ...
        <br />
        <HighlightsText>
          Ampliação e reforma de seis novas salas de aula, área administrativa,
          sala de professores, biblioteca escolar, numa área construída de
          1.000,15 m².
        </HighlightsText>
        <br />
        <br />
        ...
        <br />
        <HighlightsText>
          Fachada, nova entrada de alunos pela Rua Emetério e as salas: de
          professores, pastoral, de recursos, maker, de aula e de TI. Total de
          301,88 m² de reforma e construção.
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <HighlightsText>
          ...
          escolas adventistas, departamentos de Educação e seus índices nas
          áreas: espiritual, pedagógica e administrativa. Na ocasião, dois
          troféus foram entregues à ACSR, que obteve o 2º lugar na USB em
          pontuação geral de campo mais saudável, captação de alunos, batismos e
          crescimento: em matrículas, real da receita e na quantidade de alunos
          adventistas.
        </HighlightsText>
        <br />
        <br />
        ...
        <br />
        <HighlightsText>
          A missão de Educar Salvando é nossa razão de existir. Por isso,
          mantemos no Calendário das Escolas Adventistas da ACSR todos os
          programas missionais da IASD: 10 dias de Oração, Impacto Esperança,
          Semana Santa, Missão Calebe, Semana de Oração, Classes Bíblicas, além
          das aulas de Ensino Religioso da Educação Infantil ao Ensino Médio.
          Iniciativas que foram destaque deste quadriênio:
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <HighlightsText>
          ...
          atender alunos e pais de alunos. Atualmente, está em pleno
          ...
          alunos adolescentes participando nas sextas-feiras, à noite. Nesta
          congregação foram realizados dez batismos em 2021.
        </HighlightsText>
        <br />
        <br />
        <HighlightsText>
          Em 10 de abril de 2021, o grupo ICASM iniciou suas atividades no
          Colégio Adventista de Santa Maria. Nele existem 28 membros e 8
          interessados. As demais escolas estão na fase de implantação do grupo
          base para a formação de novas congregações.
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <br />
        <HighlightsText>
          A Jornada é realizada a cada ano, com todos os servidores das unidades
          escolares com o objetivo de resguardar a comunhão e o relacionamento
        ...
        <HighlightsText>
          ...
          participaram 90 alunos adventistas que ouviram temas sobre: família,
          história de vida, comunhão, sexualidade, relacionamento e missão.
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <br />
        <HighlightsText>
          As escolas da ACSR estão engajadas nas ações missionárias da IASD. Por
        ...
        <br />
        <HighlightsText>
          É o momento espiritual com os alunos em cada escola, semanal ou
          quinzenalmente.
        </HighlightsText>
        <br />
        <br />
        ...
        <br />
        <HighlightsText>
          Os retiros são realizados anualmente, com todos os servidores das
          unidades escolares, com o objetivo fortalecer a comunhão, o
        ...
        <HighlightsText>
          ...
          espécie. As roupas e alimentos são destinados à comunidade e ASA das
          igrejas locais. Já as doações em dinheiro são somadas às doações da
          IASD para compor o Fundo Solidário Educacional que, a cada ano, mantém
          alunos novos carentes com a anuidade escolar, livros didáticos e kit
          de uniforme escolar. Os alunos beneficiários do Fundo Solidário
          Educacional são distribuídos nas diversas unidades escolares da ACSR.
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <br />
        <HighlightsSubTitle2>
          Implementação da Coordenação da Pastoral Escolar
        </HighlightsSubTitle2>
        <br />
        <HighlightsText>
          Atualmente, sete pastores e cinco professores de Ensino Religioso
          atendem às escolas da ACSR. Desde 2021, todo o programa evangelístico
          das escolas está sendo coordenado pela professora Monie Braga com os
          pastores escolares. Assim, temos direção, missão com planejamento e
          execução muito focados em discipulado dos alunos adventistas, além da
        ...
        <HighlightsText>
          ...
          alteração. A partir de 2022, foi implantado o Novo Ensino Médio nas
          unidades de Santa Maria, Cachoeirinha e Marechal Rondon, com maior
          carga horária, preparação para a área vocacional, empreendedorismo,
        ...
        <br />
        <HighlightsText>
          Desde 2019, implantamos o Programa Bilíngue nos Colégios de
          Cachoeirinha e Marechal Rondon para as turmas da Educação Infantil e
          até o 2º ano do Ensino Fundamental. Desta forma, os alunos interagem
          com atividades na Língua Inglesa todos os dias letivos do ano, o que
          permite a fluência deles com a nova língua. Está no planejamento
          incluir outras escolas nos próximos anos.
        </HighlightsText>
        <br />
        <br />
        <br />
        ...
        <HighlightsText>
          ...
          escolas: Santo Ângelo (2019), Ijuí (2020), Cachoeirinha (2019),
        ...
        <br />
        <HighlightsText>
          Atualização de equipamentos, reestruturação de espaços e inauguração
          de salas especiais para o desenvolvimento escolar dos alunos durante
          este quadriênio, como: Laboratório de Informática, equipamentos de
          informática para salas de aulas, tablets ou Chromebooks para uso dos
          alunos em aula.
        </HighlightsText>
        <br />
        <br />
        ...
        <HighlightsText>
          ...
          unidades escolares da ACRS de fevereiro ao início de setembro de 2021:
        </HighlightsText>
        <br />
        <br />
        <br />
